...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1>(in, conv1d_15_input);
      result_t layer14_out[N_LAYER_13];

            // hls-fpga-machine-learning insert top-level-function
            myproject(conv1d_15_input,layer14_out);
    ...
    input_t conv1d_15_input[N_INPUT_1_1*N_INPUT_2_1];
    nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1>(conv1d_15_input);
    result_t layer14_out[N_LAYER_13];
