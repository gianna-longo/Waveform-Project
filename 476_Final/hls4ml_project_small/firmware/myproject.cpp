...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<conv1d_weight_t, 20>(w2, "w2.txt");
        nnet::load_weights_from_txt<conv1d_bias_t, 4>(b2, "b2.txt");
        nnet::load_weights_from_txt<conv1d_1_weight_t, 160>(w5, "w5.txt");
        nnet::load_weights_from_txt<conv1d_1_bias_t, 8>(b5, "b5.txt");
        nnet::load_weights_from_txt<conv1d_2_weight_t, 192>(w8, "w8.txt");
        nnet::load_weights_from_txt<conv1d_2_bias_t, 8>(b8, "b8.txt");
        nnet::load_weights_from_txt<dense_weight_t, 128>(w11, "w11.txt");
        nnet::load_weights_from_txt<dense_bias_t, 16>(b11, "b11.txt");
        nnet::load_weights_from_txt<dense_1_weight_t, 48>(w13, "w13.txt");
        nnet::load_weights_from_txt<dense_1_bias_t, 3>(b13, "b13.txt");
        loaded_weights = true;
    }
#endif
    ...
    nnet::global_pooling1d_cl<layer9_t, layer10_t, config10>(layer9_out, layer10_out); // global_average_pooling1d

    layer11_t layer11_out[N_LAYER_11];
    #pragma HLS ARRAY_PARTITION variable=layer11_out complete dim=0
    nnet::dense<layer10_t, layer11_t, config11>(layer10_out, layer11_out, w11, b11); // dense
    ...
    nnet::dense<layer12_t, layer13_t, config13>(layer12_out, layer13_out, w13, b13); // dense_1

    nnet::softmax<layer13_t, result_t, softmax_config14>(layer13_out, layer14_out); // dense_1_softmax
