...
class fill_buffer_5 : public FillConv1DBuffer<data_T, CONFIG_T> {
    ...
    static void fill_buffer(
        ...
        if (partition ==   1) {
            buffer[0][0] =          0; buffer[0][1] =          0; buffer[0][2] =          0; buffer[0][3] =          0; buffer[0][4] =    data[0]; buffer[0][5] =    data[1]; buffer[0][6] =    data[2]; buffer[0][7] =    data[3]; buffer[0][8] =    data[4]; buffer[0][9] =    data[5]; buffer[0][10] =    data[6]; buffer[0][11] =    data[7]; buffer[0][12] =    data[8]; buffer[0][13] =    data[9]; buffer[0][14] =   data[10]; buffer[0][15] =   data[11]; buffer[0][16] =   data[12]; buffer[0][17] =   data[13]; buffer[0][18] =   data[14]; buffer[0][19] =   data[15];
...
class fill_buffer_8 : public FillConv1DBuffer<data_T, CONFIG_T> {
    ...
    static void fill_buffer(
        ...
        if (partition ==   0) {
            buffer[0][0] =          0; buffer[0][1] =          0; buffer[0][2] =          0; buffer[0][3] =          0; buffer[0][4] =          0; buffer[0][5] =          0; buffer[0][6] =          0; buffer[0][7] =          0; buffer[0][8] =    data[0]; buffer[0][9] =    data[1]; buffer[0][10] =    data[2]; buffer[0][11] =    data[3]; buffer[0][12] =    data[4]; buffer[0][13] =    data[5]; buffer[0][14] =    data[6]; buffer[0][15] =    data[7]; buffer[0][16] =    data[8]; buffer[0][17] =    data[9]; buffer[0][18] =   data[10]; buffer[0][19] =   data[11]; buffer[0][20] =   data[12]; buffer[0][21] =   data[13]; buffer[0][22] =   data[14]; buffer[0][23] =   data[15];
